...
use crate::SelfControlFamilyV2;

use super::{
    INQUIRY_OBSERVATION_SCHEMA_V2, OWNER_INQUIRY_RECEIPT_SCHEMA_V2, OWNER_INQUIRY_SCHEMA_V2,
    SEMANTIC_STRAND_SCHEMA_V2, VolitionBudgetV1, canonical_sha256, finite_bounded_json,
    valid_bounded_text, valid_identifier, valid_sha256, valid_string_list,
};
use super::{
    InquiryFeltStatusV1, InquiryMachineStatusV1, InquiryObservationPhaseV1, InquiryRollbackStateV1,
    OwnerInquiryAnalysisV1, OwnerInquiryAuthorityBoundaryV1, OwnerInquiryCancellationV1,
    OwnerInquiryReceiptV1, OwnerInquiryStatusV1, OwnerInquiryV1, SemanticStrandProvenanceV1,
    SemanticStrandV1,
};
...
use validation::{
    ...
    expected_coverage, expected_pair_keys, identifiers_are_unique, inquiry_budget_is_offline,
    observations_form_chain, strands_are_distinct_v2,
};
...
impl SemanticStrandV2 {
    ...
    pub fn v1_view(&self) -> SemanticStrandV1 {
        SemanticStrandV1 {
            schema: super::SEMANTIC_STRAND_SCHEMA_V1.to_string(),
...
impl OwnerInquiryV2 {
    ...
    pub fn is_well_formed(&self) -> bool {
        self.schema == OWNER_INQUIRY_SCHEMA_V2
            ...
            && (super::OWNER_INQUIRY_MIN_STRANDS_V1..=super::OWNER_INQUIRY_MAX_STRANDS_V1)
    ...
    pub fn v1_view(&self) -> OwnerInquiryV1 {
        OwnerInquiryV1 {
            schema: super::OWNER_INQUIRY_SCHEMA_V1.to_string(),
