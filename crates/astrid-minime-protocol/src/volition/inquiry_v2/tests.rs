use super::super::{
    INQUIRY_OBSERVATION_SCHEMA_V1, InquiryAnalysisReceiptV1, InquiryObservationV1,
    OWNER_INQUIRY_RECEIPT_SCHEMA_V1, OWNER_INQUIRY_SCHEMA_V1, SEMANTIC_STRAND_BASE_DIMENSIONS_V1,
    SEMANTIC_STRAND_COMPANION_DIMENSIONS_V1, SEMANTIC_STRAND_SCHEMA_V1,
    canonical_semantic_strand_content_sha256, canonical_semantic_strand_embedding_sha256,
    owner_inquiry_fixed_analysis_set_v1,
};
use super::*;
use crate::{SelfControlFamilyV2, SelfControlValuesV2};
...
fn receipt_v1(inquiry: &OwnerInquiryV1) -> OwnerInquiryReceiptV1 {
    let analysis_receipts = inquiry
        ...
        .map(|analysis| {
            ...
            InquiryAnalysisReceiptV1 {
                analysis,
                input_sha256: super::super::canonical_owner_inquiry_sha256(inquiry),
    ...
    OwnerInquiryReceiptV1 {
        ...
        manifest_sha256: super::super::canonical_owner_inquiry_sha256(inquiry),
...
fn semantic_content_hash_remains_exact_bytes() {
    assert_eq!(
        super::super::canonical_semantic_strand_content_sha256("λ"),
...
fn v1_receipt_upgrade_requires_exact_manifest_and_explicit_execution_identity() {
    ...
    assert!(
        OwnerInquiryReceiptV2::from_v1_offline(&v1, &v2, &receipt_v1(&v1), mismatched_execution)
            .is_err()
    );
    ...
    assert!(
        OwnerInquiryReceiptV2::from_v1_offline(
            &v1,
            &drifted,
            &receipt_v1(&v1),
            execution_identity()
