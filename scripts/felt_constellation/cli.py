        ...
        value = (
            projector_receipt(
                ...
                status,
                {
                    ...
                    "constellations.jsonl": state_dir(workspace) / "constellations.jsonl",
                    "memberships.jsonl": state_dir(workspace) / "memberships.jsonl",
                    "unmatched_claims.jsonl": state_dir(workspace) / "unmatched_claims.jsonl",
