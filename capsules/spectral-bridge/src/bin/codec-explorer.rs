...
struct Cli {
    ...
    #[arg(
        long,
        default_value = "/Users/v/other/astrid/capsules/spectral-bridge/workspace/journal"
    )]
    ...
    #[arg(
        long,
        default_value = "/Users/v/other/astrid/capsules/spectral-bridge/workspace/state.json"
    )]
    state_file: PathBuf,
...
fn default_output_dir() -> PathBuf {
    ...
    PathBuf::from(format!(
        "/Users/v/other/astrid/capsules/spectral-bridge/workspace/diagnostics/codec_explorer/{ts}"
    ))
}
