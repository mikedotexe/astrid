...
pub(crate) fn status_report_at(path: &Path, actor: &str, limit: usize) -> String {
    ...
    let mut lines = vec![
        "=== TRANSITION PASSAGE CONTEXT V5 ===".to_string(),
        format!(
        ...
        "Dynamic-persistence boundary: active_within_restlessness and dynamic_equilibrium are owner-language alternatives to a stalled reading; neither is inferred from dispersal, entropy, elapsed time, or stage.".to_string(),
