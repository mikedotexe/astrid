...
const MANIFEST_SCHEMA: &str = "stack_build_manifest_v1";
const MANIFEST_AUTHORITY: &str = "build_manifest_witness_not_deploy_authority";
...
fn read_bound_manifest(
    ...
    let recorded_binary = PathBuf::from(string_at("/artifacts/spectral-bridge/path")?);
