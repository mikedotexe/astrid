...
pub(crate) use provider::{
    PromptAttentionV1, astrid_aperture, astrid_pressure_attenuation_depth,
    astrid_tail_participation, astrid_vibrancy_aperture, derive_browse_anchor,
    dialogue_outer_timeout_secs, dialogue_retry_tokens, estimate_dialogue_prompt_pressure_chars,
    fetch_url, format_browse_failure_context, format_browse_read_context,
    format_dialogue_web_context, format_read_more_context,
