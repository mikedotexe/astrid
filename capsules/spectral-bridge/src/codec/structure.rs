...
impl CodecStructure {
    ...
    pub fn render(&self) -> String {
        ...
        let _ = writeln!(
            s,
            "projection_basis_health_v1: source_dims={} projected_dims={} raw_column_norms={:?} normalized_column_norms={:?} near_zero_threshold={:.3e} minimum_raw_norm={:.6} minimum_column={} maximum_raw_norm={:.6} minimum_threshold_margin_ratio={:.1} near_zero_columns={:?} all_norms_finite={} normalized_columns_near_unit={} pairwise_column_count={} maximum_abs_pairwise_column_cosine={:.6} mean_abs_pairwise_column_cosine={:.6} maximum_abs_pairwise_column_cosine_pair={:?} maximum_abs_pairwise_column_cosine_threshold={:.3} columns_weakly_correlated={} dead_dimension_detected={} state={} semantic_phrase_separation_requires_embeddings={} automatic_basis_rotation={} basis_change_policy={} unhealthy_basis_response={} observational_only={} live_projection_write={} authority={}",
            ...
            basis_health.pairwise_column_count,
            basis_health.maximum_abs_pairwise_column_cosine,
            basis_health.mean_abs_pairwise_column_cosine,
            basis_health.maximum_abs_pairwise_column_cosine_pair,
            basis_health.maximum_abs_pairwise_column_cosine_threshold,
            basis_health.columns_weakly_correlated,
            basis_health.dead_dimension_detected,
            basis_health.state,
            basis_health.semantic_phrase_separation_requires_embeddings,
